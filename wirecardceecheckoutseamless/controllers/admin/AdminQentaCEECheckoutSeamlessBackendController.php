...
/**
 * @property QentaCEECheckoutSeamless module
 */
class AdminQentaCEECheckoutSeamlessBackendController extends ModuleAdminController
{
    ...
    public function renderView()
    {
        ...
        if (Tools::strlen($transaction->id_order)) {
            $index = str_replace('AdminQentaCEECheckoutSeamlessBackend', 'AdminOrders', self::$currentIndex);
